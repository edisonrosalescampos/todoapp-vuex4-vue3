  ...
  <div class="card">
    <div class="card-body">
      <div class="form-check">
        ...
        <label class="form-check-label me-2" :for="'chk' + task.id">
      ...
      <div class="d-flex gap-2 ms-2">
        <button type="button" class="btn btn-warning btn-sm rounded-circle" @click="editTask" v-if="!editTaskFlag"><i class="fas fa-pencil-alt"></i></button>
        <button type="button" class="btn btn-success btn-sm rounded-circle" @click="saveTask(task)" v-else><i class="fas fa-save"></i></button>
        <button type="button" class="btn btn-danger btn-sm rounded-circle" @click="deleteTask(task.id)"><i class="fa fa-trash"></i></button>
      </div>
    </div>
  </div>
</template>